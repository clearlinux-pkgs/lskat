...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/lskat-22.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.0/src/lskat-22.08.0.tar.xz.sig
...
%prep
%setup -q -n lskat-22.08.0
cd %{_builddir}/lskat-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661782771
mkdir -p clr-build
pushd clr-build
