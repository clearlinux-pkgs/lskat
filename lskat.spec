...
Version  : 23.08.0
Release  : 58
URL      : https://download.kde.org/stable/release-service/23.08.0/src/lskat-23.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.0/src/lskat-23.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.0/src/lskat-23.08.0.tar.xz.sig
...
%prep
%setup -q -n lskat-23.08.0
cd %{_builddir}/lskat-23.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1692998110
mkdir -p clr-build
pushd clr-build
