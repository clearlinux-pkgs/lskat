...
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/lskat-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/lskat-24.02.0.tar.xz.sig
...
%prep
%setup -q -n lskat-24.02.0
cd %{_builddir}/lskat-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709339131
mkdir -p clr-build
pushd clr-build
