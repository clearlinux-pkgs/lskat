...
Source0  : https://download.kde.org/stable/release-service/24.12.1/src/lskat-24.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.1/src/lskat-24.12.1.tar.xz.sig
...
%setup -q -n lskat-24.12.1
cd %{_builddir}/lskat-24.12.1
pushd ..
cp -a lskat-24.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736481672
mkdir -p clr-build
pushd clr-build
...
/usr/share/qlogging-categories6/lskat.renamecategories
...
/usr/share/doc/HTML/sl/lskat/index.cache.bz2
/usr/share/doc/HTML/sl/lskat/index.docbook
