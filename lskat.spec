...
Version  : 23.04.2
Release  : 56
URL      : https://download.kde.org/stable/release-service/23.04.2/src/lskat-23.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.2/src/lskat-23.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.2/src/lskat-23.04.2.tar.xz.sig
...
%prep
%setup -q -n lskat-23.04.2
cd %{_builddir}/lskat-23.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686502489
mkdir -p clr-build
pushd clr-build
