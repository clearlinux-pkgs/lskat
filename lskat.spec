...
Version  : 24.02.2
Release  : 67
URL      : https://download.kde.org/stable/release-service/24.02.2/src/lskat-24.02.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.2/src/lskat-24.02.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.2/src/lskat-24.02.2.tar.xz.sig
...
%prep
%setup -q -n lskat-24.02.2
cd %{_builddir}/lskat-24.02.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712859780
mkdir -p clr-build
pushd clr-build
