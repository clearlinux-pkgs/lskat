...
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/lskat-21.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.12.0/src/lskat-21.12.0.tar.xz.sig
...
%prep
%setup -q -n lskat-21.12.0
cd %{_builddir}/lskat-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639670535
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/lskat-21.12.0/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/lskat/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/lskat-21.12.0/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/lskat/a4c60b3fefda228cd7439d3565df043192fef137
cp %{_builddir}/lskat-21.12.0/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/lskat/a4c60b3fefda228cd7439d3565df043192fef137
pushd clr-build
%make_install
popd
%find_lang lskat
